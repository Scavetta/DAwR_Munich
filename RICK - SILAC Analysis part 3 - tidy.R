...
protein.df %>% 
  ...
  mutate(Expression = Expression - mean(Expression, na.rm = T)) -> onlyRatios       # center data on zero and save

# Alternatively, we could have applied a Z-score transformation above
# using scale(Expression)[,1]
